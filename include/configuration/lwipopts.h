/**
 * @file    lwipopts.h
 * @brief   LWIP TCP/IP stack configuration options
 * @details Configuration file for the lightweight TCP/IP stack (LWIP) used
 *          for network communication. Includes memory management, TCP tuning,
 *          protocol enables, and debug options for MQTT telemetry support
 */
