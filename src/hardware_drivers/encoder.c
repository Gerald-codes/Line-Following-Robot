/**
 * @file    encoder.c
 * @brief   GPIO encoder driver and diagnostics
 * @details
 *   Implements active-low encoder edge counting using GPIO interrupts.
 *   Provides initialization and reset functions, pin state printing,
 *   and diagnostic tests for encoder signal wiring and Grove connections.
 */
...
/**
 * @brief   Encoder interrupt handler for ACTIVE-LOW encoders
 * @param   gpio GPIO pin
 * @param   events Interrupt event type (rising/falling edge)
 */
...
/**
 * @brief   Initialize encoder GPIO pins and IRQ for ACTIVE-LOW operation
 */
...
/**
 * @brief   Reset encoder counts for both left and right wheels
 */
...
/**
 * @brief   Print encoder values and pin states for diagnostics
 */
...
/**
 * @brief   Get current left encoder count
...
/**
 * @brief   Get current right encoder count
 * @return  Current count value
 */
...
/**
 * @brief   Diagnostic: Test raw encoder signals and print state changes
 */
...
/**
 * @brief   Diagnostic: Scan all Grove 2 & 3 pins to verify encoder connections
 */
